...
class DexterousHandKinematics:
    ...
    def calculate_theta1(self):
        ...
        #don't know why there is a pi bias, but it works
...
if __name__ == "__main__":
    ...
    dhk = DexterousHandKinematics(ax, ay, bx, by, p, l1, l2, l3, l4, cy, h, r1, r2, r3, r4, u1, u2, u3, u4, beta1,
                                  beta2, beta3, theta4)
    start_time = time.time()
    dhk.update(q1 = 13.61/180*math.pi, q2 = 0, q3 = (180-45.02)/180*math.pi)
    print(dhk.d)
    print(dhk.Pp_dip)
